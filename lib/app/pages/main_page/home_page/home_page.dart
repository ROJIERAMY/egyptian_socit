                            ...
                            SliverToBoxAdapter(
                              child: Column(
                                children: [
                                  ...
                                  //   children: [
                                  //
                                  //     HomeWidget.titleAndMore(appText.categories, onTapViewAll: (){
                                  ...
                                  Column(
                                    children: [
                                      HomeWidget.titleAndMore(appText.newcourses, isViewAll: false),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "Categories",
                style: style16Bold(), // تعديل خط العنوان
              ),
              GestureDetector(
                onTap: onViewAllTap ?? () {},
                child: Text(
                  "View All",
                  style: style14Bold().copyWith(color: blueF2()), // لون مميز
                ),
              ),
            ],
          ),
                    ...
                    children: [
                      category.icon != null
                        ...
                        fit: BoxFit.contain,
                          ...
                          : Icon(Icons.category, size: 32, color: blueF2()),
